...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Foundry — YouTube Product Review Pipeline" },
      { name: "description", content: "Paste a YouTube URL and get a full product review: transcript, product detection, frame vision analysis, script, and SEO." },
      { name: "author", content: "Foundry" },
      { property: "og:title", content: "Foundry — Review Pipeline" },
      { property: "og:description", content: "YouTube to product review, end to end." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Geist+Mono:wght@300;400;500;600&display=swap" },
